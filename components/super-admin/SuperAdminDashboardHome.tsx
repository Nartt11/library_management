  ...
  const systemAlerts = [
    {
      id: "1",
      type: "warning",
      message: "8 books are overdue and need attention",
      time: "2 hours ago",
    },
    {
      id: "2",
    ...
    },
    {
      id: "3",
      type: "success",
      message: "System security scan passed",
      time: "12 hours ago",
    },
  ];
    ...
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Complete library management system dashboard.
        </p>
      </div>
              ...
              {userBreakdown.map((user) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      variant={
                        user.change.startsWith("+") ? "default" : "outline"
                      }
                    >
                      {user.change}
                    </Badge>
          ...
          <CardContent>
            <div className="space-y-3">
              {systemAlerts.map((alert) => (
                ...
                >
                  <AlertTriangle
                    className={`h-4 w-4 mt-0.5 shrink-0 ${getAlertColor(
                      alert.type
                    )}`}
                  />
