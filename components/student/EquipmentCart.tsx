    ...
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Review your selected equipment and generate a reservation QR ticket.
        </p>
      </div>
        ...
        <Card>
          <CardContent className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-4">
              Browse our equipment catalog to add items to your cart.
            </p>
          </CardContent>
        </Card>
      ) : (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            <Card>
              <CardHeader>
                <CardTitle>
                  Equipment in Cart ({cartEquipment.length})
                </CardTitle>
                <CardDescription>
                  Review your selected equipment before generating QR ticket
                </CardDescription>
              </CardHeader>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Provide details for your equipment reservation
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {
                        cartEquipment.filter((item) => item.type === "computer")
                          .length
                      }
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {
                        cartEquipment.filter(
                          (item) => item.type === "board-game"
                        ).length
                      }
                    </span>
                  </div>
