...
export function BookCart({
  ...
  const handleCheckout = () => {
    ...
    toast.success(
      "QR code generated! Show this to the librarian to complete checkout."
    );
  };
            ...
            <div className="space-y-4">
              ...
              {currentQR.books && currentQR.books.length > 0 && (
                <div className="bg-teal-50 border border-teal-200 rounded-xl p-3">
                  <h4 className="text-sm font-medium text-teal-700 mb-2 text-center">
                    Books to Checkout
                  </h4>
                  <div className="space-y-2 max-h-24 overflow-y-auto">
                    {currentQR.books.map((book: any, index: number) => (
                      <div
                        key={book.id}
                        className="bg-white p-2 rounded-lg border border-teal-100"
                      >
