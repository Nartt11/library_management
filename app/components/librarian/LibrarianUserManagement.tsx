...
// import { Users, Search, Edit, Filter, Eye, EyeOff, BookOpen, Calendar, Clock, User as UserIcon } from 'lucide-react';
...
// export function LibrarianUserManagement({ currentUser }: LibrarianUserManagementProps) {
...
//       {
//         id: 'br-6',
//         bookTitle: 'Python Crash Course: A Hands-On, Project-Based Introduction',
//         author: 'Eric Matthes',
//         isbn: '9781593279288',
...
//   const confirmUpdateUserStatus = (userId: string, newStatus: 'active' | 'disabled', userName: string) => {
//     setPendingAction({
//       action: () => updateUserStatus(userId, newStatus, userName),
//       title: 'Update User Status',
//       description: `You are about to change ${userName}'s status to ${newStatus}. This will ${newStatus === 'disabled' ? 'prevent them from accessing the system' : 'allow them to access the system'}.`,
//     });
//     setShowPasswordConfirmation(true);
//   };

//   const updateUserStatus = (userId: string, newStatus: 'active' | 'disabled', userName: string) => {
...
//             User Management
//           </h1>
//           <p className="text-muted-foreground">View and manage user accounts and information.</p>
//         </div>
//       </div>
...
//               Edit User
//             </DialogTitle>
//             <DialogDescription>Update user information and change password if needed.</DialogDescription>
//           </DialogHeader>
...
//               <Button onClick={confirmUpdateUser} className="flex-1">Update User</Button>
//               <Button
//                 onClick={() => {
//                   setIsEditDialogOpen(false);
//                   setEditingUser(null);
...
//                     <td
//                       className={`p-4 ${user.role === 'student' ? 'cursor-pointer hover:bg-orange-50/50' : ''}`}
...
//                         {user.role === 'student' && getBorrowingStats(user.id).total > 0 && (
...
//                         <Select
//                           value={user.status}
//                           onValueChange={(value: 'active' | 'disabled') => confirmUpdateUserStatus(user.id, value, user.name)}
//                         >
...
//       <Dialog open={isBorrowingHistoryOpen} onOpenChange={setIsBorrowingHistoryOpen}>
...
//                           <div className="text-2xl font-bold text-green-600 mb-2">{stats.returned}</div>
...
//                           <div className="text-2xl font-bold text-blue-600 mb-2">{stats.active}</div>
...
//                           <div className="text-2xl font-bold text-red-600 mb-2">{stats.overdue}</div>
...
//                           <div className="text-2xl font-bold text-orange-600 mb-2">{stats.total}</div>
//                           <div className="text-sm text-orange-700">Total Books</div>
//                         </div>
//                       </>
//                     );
//                   })()}
...
//                 {/* Detailed History */}
//                 <div>
//                   <h3 className="text-xl font-medium mb-8 text-gray-900">Detailed Borrowing History</h3>

//                   <div className="space-y-6">
//                     {getStudentBorrowingHistory(selectedStudent.id).map((record) => (
//                       <div key={record.id} className="border border-orange-200 rounded-xl p-8 bg-white hover:bg-orange-50/50 hover:shadow-lg transition-all duration-200">
//                         <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-8">
//                           {/* Book Information */}
//                           <div className="flex-1 min-w-0">
//                             <div className="flex items-start justify-between mb-4">
//                               <div className="flex-1 min-w-0 pr-4">
//                                 <h4 className="text-lg font-medium text-gray-900 line-clamp-2 mb-2">{record.bookTitle}</h4>
//                                 <p className="text-gray-600 mb-1">by {record.author}</p>
//                                 <p className="text-sm text-gray-500">ISBN: {record.isbn}</p>
//                               </div>
//                               <Badge variant={getStatusBadgeVariant(record.status)} className="flex-shrink-0 px-3 py-1">
...
//                                 <span className="text-gray-500 block text-xs uppercase tracking-wide mb-1">Borrowed</span>
//                                 <span className="font-medium text-gray-900">{new Date(record.borrowDate).toLocaleDateString()}</span>
//                               </div>
//                               <div className="text-center">
//                                 <span className="text-gray-500 block text-xs uppercase tracking-wide mb-1">Due</span>
//                                 <span className="font-medium text-gray-900">{new Date(record.dueDate).toLocaleDateString()}</span>
//                               </div>
//                               <div className="text-center">
//                                 <span className="text-gray-500 block text-xs uppercase tracking-wide mb-1">Returned</span>
...
//                               <span className="text-gray-500 block text-xs uppercase tracking-wide mb-1">Staff Member</span>
...
//                     {getStudentBorrowingHistory(selectedStudent.id).length === 0 && (
//                       <div className="text-center py-16 text-gray-500">
//                         <BookOpen className="h-16 w-16 mx-auto mb-4 text-gray-300" />
//                         <p className="text-lg">No borrowing history found</p>
//                         <p className="text-sm mt-2">This student hasn't borrowed any books yet.</p>
//                       </div>
//                     )}
//                   </div>
//                 </div>
...
//               <Button onClick={() => setIsBorrowingHistoryOpen(false)} variant="outline" className="px-6 py-2">
//                 Close
//               </Button>
//             </div>
//           </div>
