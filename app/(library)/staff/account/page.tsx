                  ...
                  <Avatar className="h-16 w-16">
                    {profileForm.imageUrl ? (
                      ...
                      <AvatarFallback className="text-lg">
                        {getInitials(profileForm.fullName ?? currentUser.name)}
                      </AvatarFallback>
                    )}
                  </Avatar>
                  <div>
                    <h3 className="text-lg font-medium">{profileForm.fullName ?? currentUser.name}</h3>
                    <p className="text-muted-foreground">{profileForm.email ?? currentUser.email}</p>
              ...
              {isEditingProfile ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="mt-1">{profileForm.fullName ?? currentUser.name}</p>
                  </div>
                  <div>
                    <Label className="text-sm font-medium text-muted-foreground">
                      Email Address
                    </Label>
                    <p className="mt-1">{profileForm.email ?? currentUser.email}</p>
                  </div>
                  <div>
                    <Label className="text-sm font-medium text-muted-foreground">
                      Phone Number
